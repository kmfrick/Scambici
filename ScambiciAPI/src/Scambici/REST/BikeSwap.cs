...
namespace Scambici.REST
{
	...
	public static class BikeSwap
	{ 
		[FunctionName("BikeSwap")]
				...
				ILogger log)
		{
			...
			var requestData = JsonConvert.DeserializeObject<FormBikeSwap>(requestBody);
			try
			{
				...
				var user = ((Scambici.Domain.UserMaintenance) employee.CurrentTask).CreatedBy;
				...
				userMaintController.ReplaceBike(bikeId, user, store);
