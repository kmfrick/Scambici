...
{
	public class ReplaceBikeUserMaintenanceTestable : Scambici.EmployeeAPI.UserMaintenance.UserMaintenanceController
	{
		public ReplaceBikeUserMaintenanceTestable(Scambici.Domain.ScambiciContext context)
		{	dbContext = context; }
	}

	[NUnit.Framework.TestFixture]
	public class UserMaintenanceController_ReplaceBike
	{
		...
		public void SetUp()
		{
			...
			controller = new ReplaceBikeUserMaintenanceTestable(dbContext);
			//Admin
		...
		public void UserMaintenanceController_DBUserHasMaintenance_ReplaceBike()
		{
			NUnit.Framework.Assert.That(dbContext.Users.First().RentedBike.BikeId, NUnit.Framework.Is.EqualTo(5566));
			NUnit.Framework.Assert.That(() => controller.ReplaceBike(7788, dbContext.Users.First(), dbContext.Stores.First()), NUnit.Framework.Throws.Nothing);
			NUnit.Framework.Assert.That(dbContext.Users.First().RentedBike.BikeId, NUnit.Framework.Is.EqualTo(7788));
		}
	}
}
