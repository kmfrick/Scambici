...
{
	public class TakeTaskMaintenanceTestable : Scambici.EmployeeAPI.UserMaintenance.UserMaintenanceController
	{
		public TakeTaskMaintenanceTestable(Scambici.Domain.ScambiciContext context)
		{	dbContext = context; }
	}

	[NUnit.Framework.TestFixture]
	public class UserMaintenanceController_TakeTask
	{
		...
		public void SetUp()
		{
			...
			controller = new TakeTaskMaintenanceTestable(dbContext);
			//Admin
		...
		public void UserMaintenanceController_DBUserHasMaintenance_TakeTask()
		{
			NUnit.Framework.Assert.That(dbContext.Employees.First().CurrentTask, NUnit.Framework.Is.EqualTo(null));
			NUnit.Framework.Assert.That(() => controller.TakeTask(dbContext.Employees.First(), dbContext.UserMaintenances.First().TaskId), NUnit.Framework.Throws.Nothing);
