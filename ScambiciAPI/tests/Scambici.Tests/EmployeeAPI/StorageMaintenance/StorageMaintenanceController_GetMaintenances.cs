...
{
	public class GetStorageMaintenanceTestable : Scambici.EmployeeAPI.StorageMaintenance.StorageMaintenanceController
	{
		public GetStorageMaintenanceTestable(Scambici.Domain.ScambiciContext context)
		{	dbContext = context; }
	}

	[NUnit.Framework.TestFixture]
	public class StorageMaintenanceController_GetMaintenances
	{
		...
		public void SetUp()
		{
			...
			controller = new GetStorageMaintenanceTestable(dbContext);
			//Admin
		...
		public void StorageMaintenanceController_DBStoreHasStorageMaintenance_GetMaintenance()
		{
			NUnit.Framework.Assert.That(() => controller.GetStorageMaintenances(dbContext.Stores.First()), NUnit.Framework.Throws.Nothing);
			...
			NUnit.Framework.Assert.That(storage[0].TaskId, NUnit.Framework.Is.EqualTo(7));
		}
	}
}